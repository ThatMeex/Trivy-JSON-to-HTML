!(function (t, n) {
    ...
    function k(t, n, e, r, o) {
        var i = { type: t, props: n, key: e, ref: r, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: null == o ? ++p : o };
        ...
        for (var t; (I.__r = h.length); )
            (t = h.sort(function (t, n) {
                ...
                t.some(function (t) {
                    ...
                    t.__d &&
                        ((i = (o = (n = t).__v).__e),
                        (u = n.__P) && ((e = []), ((r = b({}, o)).__v = o.__v + 1), R(u, o, r, n.__n, void 0 !== u.ownerSVGElement, null != o.__h ? [i] : null, e, null == i ? N(o) : i, o.__h), F(e, o), o.__e != i && C(o)));
                });
    }
        ...
        for (e.__k = [], c = 0; c < n.length; c++)
            if (
                ...
                R(t, d, (p = p || v), o, i, u, s, a, l),
                    (h = d.__e),
                    (f = d.ref) && p.ref != f && (m || (m = []), p.ref && m.push(p.ref, null, d), m.push(f, d.__c || h, d)),
                    null != h
                        ? (null == _ && (_ = h), "function" == typeof d.type && d.__k === p.__k ? (d.__d = a = L(d, a, t)) : (a = A(t, d, p, y, h, a)), "function" == typeof e.type && (e.__d = a))
    ...
    function H(t, n, e, r, o) {
        ...
        t: if ("style" === n)
            if ("string" == typeof e) t.style.cssText = e;
                ...
                if (("string" == typeof r && (t.style.cssText = r = ""), r)) for (n in r) (e && n in e) || j(t.style, n, "");
                if (e) for (n in e) (r && e[n] === r[n]) || j(t.style, n, e[n]);
            }
        else if ("o" === n[0] && "n" === n[1])
            ...
            t: if ("function" == typeof E) {
                if (
                    ...
                    e.__c
                        ...
                        : ("prototype" in E && E.prototype.render ? (n.__c = c = new E(v, y)) : ((n.__c = c = new S(v, y)), (c.constructor = E), (c.render = B)),
                          g && g.sub(c),
                          (c.props = v),
                          c.state || (c.state = {}),
                          (c.context = y),
                    ...
                    null != E.getDerivedStateFromProps && (c.__s == c.state && (c.__s = b({}, c.__s)), b(c.__s, E.getDerivedStateFromProps(v, c.__s))),
                    (d = c.props),
                    (h = c.state),
                    p)
                )
                    null == E.getDerivedStateFromProps && null != c.componentWillMount && c.componentWillMount(), null != c.componentDidMount && c.__h.push(c.componentDidMount);
                else {
                    if (
                        (null == E.getDerivedStateFromProps && v !== d && null != c.componentWillReceiveProps && c.componentWillReceiveProps(v, y),
        ...
        if (null === h) p === d || (s && t.data === d) || (t.data = d);
            ...
            if (
                ((function (t, n, e, r, o) {
                    ...
                    for (i in n) (o && "function" != typeof n[i]) || "children" === i || "key" === i || "value" === i || "checked" === i || e[i] === n[i] || H(t, i, n[i], e[i], r);
                })(t, d, p, o, s),
                f)
            )
                n.__k = [];
            else if (((_ = n.props.children), T(t, Array.isArray(_) ? _ : [_], n, e, r, o && "foreignObject" !== h, i, u, i ? i[0] : e.__k && N(e, 0), s), null != i)) for (_ = i.length; _--; ) null != i[_] && w(i[_]);
            s ||
                ("value" in d && void 0 !== (_ = d.value) && (_ !== t.value || ("progress" === h && !_) || ("option" === h && _ !== p.value)) && H(t, "value", _, p.value, !1),
        ...
        (f = {
            __e: function (t, n, e, r) {
                for (var o, i, u; (n = n.__); )
                    if ((o = n.__c) && !o.__)
                        try {
                            if (((i = o.constructor) && null != i.getDerivedStateFromError && (o.setState(i.getDerivedStateFromError(t)), (u = o.__d)), null != o.componentDidCatch && (o.componentDidCatch(t, r || {}), (u = o.__d)), u))
                                return (o.__E = o);
                        } catch (n) {
                            t = n;
                        }
    ...
    function $(t) {
        return x(t.parentElement || "span", { dangerouslySetInnerHTML: { __html: t.content } });
    }
    function G(t, n) {
    ...
    (f.__b = function (t) {
        ...
        (f.diffed = function (t) {
            ...
            n &&
                n.__H &&
                (n.__H.__h.length && ((1 !== ct.push(n) && st === f.requestAnimationFrame) || ((st = f.requestAnimationFrame) || Pt)(xt)),
    ...
    function Mt() {
                ...
                function () {
                    r(
                        i.server
                            ...
                            : new nt({ keyword: i.keyword, columns: o.header && o.header.columns, ignoreHiddenColumns: i.ignoreHiddenColumns || void 0 === i.ignoreHiddenColumns, selector: i.selector })
                    ),
        ...
        return x(
            ...
            x("input", { type: "search", placeholder: u("search.placeholder"), "aria-label": u("search.placeholder"), onInput: p, className: rt(et("input"), et("search", "input")), value: (null == a ? void 0 : a.keyword) || "" })
        );
    }
    ...
    function Ot() {
        ...
        yt(function () {
            return (
                e ? ((v.current = new Ft({ limit: p, page: y, url: e.url, body: e.body })), t.pipeline.register(v.current)) : ((v.current = new Rt({ limit: p, page: y })), t.pipeline.register(v.current)),
        ...
        return x(
            ...
            x(
                ...
                o &&
                    ...
                    x(
                        "div",
                        { role: "status", "aria-live": "polite", className: rt(et("summary"), t.className.paginationSummary), title: N("pagination.navigate", y + 1, E()) },
                        ...
                        x(
                            ...
                            E() > n &&
                                ...
                                x(
                                    ...
                                    x("button", { tabIndex: -1, className: rt(et("spread"), t.className.paginationButton) }, "...")
                                ),
            ...
            return (
                    ...
                    n.current &&
                        ...
                        (l = (function (t) {
                            ...
                            var i = Array.from(n.parentNode.querySelectorAll("thead th")).reduce(function (t, n) {
                                var e;
                                return (n.style.width = n.clientWidth + "px"), r((((e = {})[n.getAttribute("data-column-id")] = { minWidth: n.clientWidth }), e), t);
                            }, {});
                            return (
                                (n.className = e),
                                (n.style.cssText = o),
                ...
                (u.populatePlugins = function (n, e) {
                    for (var o, i = a(e); !(o = i()).done; ) {
                        var u = o.value;
                        void 0 !== u.plugin && n.add(r({ id: u.id }, u.plugin, { position: t.PluginPosition.Cell }));
                    }
                }),
                ...
                (e.get = function (t) {
                    ...
                    return "function" == typeof n.data
                        ...
                        : fetch(n.url, n)
                              ...
                              .then(function (t) {
                                  return { data: n.then(t), total: "function" == typeof n.total ? n.total(t) : void 0 };
                              });
                }),
                n
            );
            ...
            return (
                (t.createFromConfig = function (t) {
                    ...
                    return (
                        ...
                        t.from && ((n = new Zt(this.tableElementToArray(t.from))), (t.from.style.display = "none")),
    ...
    var rn = /*#__PURE__*/ (function (t) {
                        ...
                        : t.map(function (t) {
                              return n.map(function (n, e) {
                                  return void 0 !== n.data
                                      ...
                                      : n.id
                                      ? t[n.id]
                                      : (Vt.error("Could not find the correct cell for column at position " + e + ".\n                          Make sure either 'id' or 'selector' is defined for all columns."), null);
                              });
                          });
                }),
                (r._process = function (t) {
        ...
        ln = /*#__PURE__*/ (function () {
            ...
            return (
                (t.createFromConfig = function (t) {
                    var n = new rn();
                    return t.storage instanceof Jt && n.register(new sn({ serverStorageOptions: t.server })), n.register(new on({ storage: t.storage })), n.register(new an({ header: t.header })), n.register(new un()), n;
                }),
                t
            );
        })(),
        ...
        pn = /*#__PURE__*/ (function () {
            ...
            return (
                ...
                (n.defaultConfig = function () {
                    return { store: new cn({ status: l.Init, header: void 0, data: null }), plugin: new $t(), tableRef: { current: null }, width: "100%", height: "auto", processingThrottleMs: 100, autoWidth: !0, style: {}, className: {} };
                }),
                (n.fromPartialConfig = function (e) {
                    var r = new n().assign(e);
                    return (
                        "boolean" == typeof e.sort && e.sort && r.assign({ sort: { multiColumn: !0 } }),
                        ...
                        r.search && r.plugin.add({ id: "search", position: t.PluginPosition.Header, component: Mt }),
                        r.pagination && r.plugin.add({ id: "pagination", position: t.PluginPosition.Footer, component: Ot }),
                        r.plugins &&
    ...
    function dn(t) {
        ...
        return x(
            ...
            r(
                ...
                (n = t.column) ? ("function" == typeof n.attributes ? n.attributes(t.cell.data, t.row, t.column) : n.attributes) : {}
            ),
            t.column && "function" == typeof t.column.formatter
                ? t.column.formatter(t.cell.data, t.row, t.column)
                : t.column && t.column.plugin
                ? x(Gt, { pluginId: t.column.id, props: { column: t.column, cell: t.cell, row: t.row } })
                : t.cell.data
        );
    }
    function hn(t) {
        ...
        return x(
            ...
            t.children
                ...
                : t.row.cells.map(function (n, r) {
                      ...
                      return o && o.hidden ? null : x(dn, { key: n.id, cell: n, row: t.row, column: o });
                  })
        );
    }
    function _n(t) {
        return x(hn, { messageRow: !0 }, x(dn, { role: "alert", colSpan: t.colSpan, messageCell: !0, cell: new X(t.message), className: rt(et("message"), t.className ? t.className : null) }));
    }
    function mn() {
        var t = It(),
            n = Dt(function (t) {
        ...
        return x(
            ...
            e === l.Loading && (!n || 0 === n.length) && x(_n, { message: o("loading"), colSpan: i(), className: rt(et("loading"), t.className.loading) }),
            e === l.Rendered && n && 0 === n.length && x(_n, { message: o("noRecordsFound"), colSpan: i(), className: rt(et("notfound"), t.className.notfound) }),
            e === l.Error && x(_n, { message: o("error"), colSpan: i(), className: rt(et("error"), t.className.error) })
        );
    }
        ...
        gn = function (t, n, e, o) {
            return function (i) {
                var u,
                    ...
                    p = !1,
                    d = !1;
                if ((void 0 !== l ? (e ? (-1 === l.direction ? (p = !0) : (d = !0)) : 1 === a ? (d = !0) : a > 1 && ((f = !0), (c = !0))) : 0 === a ? (c = !0) : a > 0 && !e ? ((c = !0), (f = !0)) : a > 0 && e && (c = !0), f && (s = []), c))
    ...
    function wn(t) {
        ...
        return (
            yt(
                function () {
                    var t = f() || (c === K.ServerSort ? new bn(r({ columns: l ? l.columns : [] }, a.server)) : new vn({ columns: l ? l.columns : [] }));
                    return (
            ...
            r(
                {
                    ...
                    onClick: c,
                    style: r({}, n.style.th, { minWidth: t.column.minWidth, width: t.column.width }, i, t.style),
                ...
                (a = t.column) ? ("function" == typeof a.attributes ? a.attributes(null, null, t.column) : a.attributes) : {},
                l() ? { tabIndex: 0 } : {}
            ),
            x("div", { className: et("th", "content") }, void 0 !== t.column.name ? t.column.name : void 0 !== t.column.plugin ? x(Gt, { pluginId: t.column.plugin.id, props: { column: t.column } }) : null),
            l() && x(wn, r({ index: t.index }, t.column.sort)),
            t.column.resizable && t.index < n.header.visibleColumns.length - 1 && x(kn, { column: t.column, thRef: e })
        );
    }
    function Sn() {
        var t,
                                      ...
                                      : (function (t, n, e, r) {
                                            var o = (function (t, n, e) {
                                                var r = Kt.maximumDepth(t),
                                                    o = e - n;
                                                return { rowSpan: Math.floor(o - r - r / o), colSpan: (t.columns && t.columns.length) || 1 };
                                            })(t, n, r);
                                            return x(Pn, { column: t, index: e, colSpan: o.colSpan, rowSpan: o.rowSpan });
                                        })(t, n, o.indexOf(t), r);
                              })
                          );
                      })(n, r, t.length);
    ...
    function Cn() {
        ...
        return (
            ...
            x("table", { ref: n, role: "grid", className: rt(et("table"), t.className.table), style: r({}, t.style.table, { height: t.height }) }, x(Sn, null), x(mn, null))
        );
    }
    function En() {
        var n = gt(!0),
        ...
        return (
            ...
            e ? x("div", { ref: i, className: rt(et("head"), u.className.header), style: r({}, u.style.header) }, x(Gt, { position: t.PluginPosition.Header })) : null
        );
    }
    function In() {
        var n = bt(null),
        ...
        return (
            ...
            o ? x("div", { ref: n, className: rt(et("footer"), u.className.footer), style: r({}, u.style.footer) }, x(Gt, { position: t.PluginPosition.Footer })) : null
        );
    }
    function Tn() {
        var t = It(),
                        ...
                        try {
                            var i = Promise.resolve(t.pipeline.process()).then(function (t) {
                                n(
                                    ...
                                    setTimeout(function () {
                                        n(function (t) {
                                            return t.status === l.Loaded ? r({}, t, { status: l.Rendered }) : t;
                                        });
                                    }, 0);
                            });
                        } catch (t) {
        ...
        return (
            ...
            x(
                "div",
                { role: "complementary", className: rt("gridjs", et("container"), e === l.Loading ? et("loading") : null, t.className.container), style: r({}, t.style.container, { width: t.width }) },
                e === l.Loading && x("div", { className: et("loading-bar") }),
                x(En, null),
                x("div", { className: et("wrapper"), style: { height: t.height } }, x(Cn, null)),
                x(In, null),
    ...
    var Ln = /*#__PURE__*/ (function (t) {
        function n(n) {
            var e;
            return ((e = t.call(this) || this).config = void 0), (e.plugin = void 0), (e.config = new pn().assign({ instance: u(e), eventEmitter: u(e) }).update(n)), (e.plugin = e.config.plugin), e;
        }
        o(n, t);
        var e = n.prototype;
        return (
            ...
            (e.render = function (t) {
                return (
                    ...
                    t.childNodes.length > 0 ? (Vt.error("The container element " + t + " is not empty. Make sure the container is empty and call render() again"), this) : ((this.config.container = t), q(this.createElement(), t), this)
                );
            }),
            n
        );
